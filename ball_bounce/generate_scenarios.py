...
def generate_random_scenario():
    ...
    scenario = {
        ...
        "size_change": random.randint(-5, 5),
        ...
        "carrying_capacity": random.randint(50, 300),
...
if __name__ == "__main__":
    ...
    parser.add_argument('num_scenarios', type=int, nargs='?', default=10, help='Number of scenarios to generate.')
